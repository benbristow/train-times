...
class LDBWS
  ...
  def extract_services(board_response)
    raise TrainTimesError, 'No train times found' if board_response[:get_station_board_result][:train_services].nil?
  ...
  def access_token
    raise TrainTimesError, 'No national rail access token provided' unless ENV['NATIONAL_RAIL_TOKEN']
